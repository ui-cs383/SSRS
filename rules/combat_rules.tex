...
\begin{center}
  ...
  \begin{longtable}{| p{\first} | p{\second} | p{\third} | p{\fourth} |}
    ...
    \newrule{Either player can initiate combat during any playerÕs Combat segment.}{10.0}{-}
    ...
    \newrule{The maximum ratios are Ô1?5Õ and Ô5?1Õ for combat without leaders. Any computed ratio outside that range shall be set to the nearest ratio.}{10.22}{-}
    
    \newrule{For environ combat with leaders, the maximum ratios are Ô1?6Õ and Ô6?1Õ.}{10.42}{-}
    ...
    \newrule{In a ÒspecialÓ environ, the Imperial player receives a column penalty (unless there is a leader) independent of any other bonus/penalty.}{10.5}{-}
    
    \newrule{Characters stacked with military units in combat are not effected or effect combat.}{10.6}{-}
    
    \newrule{If a playerÕs military units are eliminated during combat, the characters are immediately attacked by the surviving military units (squad) according to the rules of character combat.}{10.6}{-}
...
\begin{center}
  ...
  \begin{longtable}{| p{\first} | p{\second} | p{\third} | p{\fourth} |}
    ...
    \newrule{Combat is of one of two types: Òhand?to?handÓ and ÒfirefightÓ.}{12.3}{-}
    ...
    \newrule{If the attacking group is a ÒsquadÓ (from ?found?), the combat is always ÒfirefightÓ.}{12.31}{-}
    
    \newrule{If the attacking group is a groups of characters, the attacking group determines the type of combat.}{12.32}{-}
    
    \newrule{Defending playerÕs characters are divided into two groups: ÒactiveÓ and ÒinactiveÓ.}{12.4}{-}
    ...
    \newrule{Active characters still gain possession bonuses (for Rebels).}{12.41}{-}
    
    \newrule{Inactive characters have a better chance of Òbreak offÓ.}{12.42}{-}
    
    \newrule{Active and inactive character selection occurs before each round of combat.}{12.43}{-}
    
    \newrule{The attacking player is never divided into active and inactive parts, all parts attack.}{12.44}{-}
    
    \newrule{Before resolving a round of combat, the defending player can attempt to Òbreak offÓ.}{12.5}{-}
    
    \newrule{Both active and inactive characters can attempt to ÒBreak offÓ.}{12.5}{-}
    ...
    \newrule{If the combat is of type ÒfirefightÓ, all combat results are doubled.}{12.6}{-}
    
    \newrule{If the combat is of type Òhand?to?handÓ, all combat results are normal.}{12.6}{-}
