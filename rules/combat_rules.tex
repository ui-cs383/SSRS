...
\begin{center}
  ...
  \begin{longtable}{| p{\first} | p{\second} | p{\third} | p{\fourth} |}
    ...
    \newrule{Wounds assigned to attacking units are substracted from combat strength.}{12.74}{4}
...
\begin{center}
  ...
  \begin{longtable}{| p{\first} | p{\second} | p{\third} | p{\fourth} |}
    ...
    \newrule{An attack by a Level 1 PDB is resolved using the ‘1-1’ column of the table.}{9.22}{1}
