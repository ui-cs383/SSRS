...
\clearpage{\centering\selectlanguage{english}\bfseries\color{black}
Freedom in the Star System SSRS
\par}
...
M
 &
Initial copy, filled in details
 &
~
 &
~
...
% Below are additional lines.  Each ``hline'' ends a new entry.
\begin{comment}
~
 &
~
...
for the system is Dr. Clinton Jeffrey, University of Idaho.  The ultimate
customer, or end-user, of the system will be the general public.  This is a new project effort, so the version under development is version 0.1.0
...
\textit{Freedom in the Galaxy} is a board game designed and owned by SPI (now Avalon Hill) in 1978.  Freedom in the Star System will be a digital representation of the board game for the purposes of practicing software engineering standards in a controlled, educational environment.
...
\selectlanguage{english}\color{black} System and Software Requirements (this document)
Specification\\\hline
FITG
 &
